          ...
          <div className="flex items-center py-16 border-b-2 border-gray-900 mb-10">
            ...
            <div className="w-3/4">
              <p className="leading-loose">
                ...
                brand at prime booth locations, interact in style with a
                dedicated Hospitality Suite, and feature a speaker for product
                endorsement. Enjoy free admissions, live acknowledgment, and
