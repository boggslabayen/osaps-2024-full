          ...
          <div className="flex items-center py-16 border-b-2 border-gray-900 mb-10">
            ...
            <div className="w-3/4">
              <p className="leading-loose">
                Shine as a Silver Sponsor: Secure a prime booth location,
                showcase your brand onstage, enjoy free admissions, Gala Dinner
                tickets, and live acknowledgment throughout the event.
              </p>
            </div>
          </div>
          <div>
