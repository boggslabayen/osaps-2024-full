...
import { Select, Option, Button } from "../ui/mtwexport";
    ...
    <div className="max-w-screen">
      ...
      <div className="mx-auto max-w-fit lg:max-w-screen-xl my-12 ">
        <p className="text-gray-800 mb-4 text-xl leading-10 font-normal mx-8">
          Get ready to join us for OSAPS 2024, hosted at the luxurious{" "}
          <span className="font-bold">
            Shangri-La Mactan, Cebu, from July 4-6, 2024.
          </span>{" "}
          We offer flexible pricing options to suit your needs:
        </p>

        <DefaultTable />
        <p className="text-gray-800 my-4 font-normal mx-8">
          Exclusive discounts available for PAPRAS and PBPS affiliates upon
          checkout!
        </p>

        <p className="text-gray-800 my-8 text-xl leading-10 font-normal mx-8">
          Enhance your OSAPS 2024 experience by including the Gala Night Dinner
          on <span className="font-bold">July 5, 2024</span>, with your
          registration. Alternatively, register a guest or companion to maximize
          participation!
        </p>
        ...
        <p className="text-gray-800 my-8 text-xl leading-10 font-normal mx-8">
          *Additional Guests - Registrants have the option to register one
          spouse or guest. The guest registration covers Exhibit Hall access,
          lunch and refreshment breaks with exhibitors. Guests are not permitted
          in educational sessions and guests may not claim CME credit.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-fit lg:max-w-screen-xl my-12 ">
        ...
        <div className="flex justify-center">
          <Link href="https://forms.gle/T8PMEEi4zRDm6yN46" target="_blank">
            <Button
              variant="filled"
              className="bg-amber-500 rounded-full text-blue-jay mx-8"
              size="lg"
              ripple={true}>
              Register Now
            </Button>
