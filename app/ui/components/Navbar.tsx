      ...
      <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-8 py-6 lg:px-8 lg:py-4 bg-blue-jay">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className='flex hidden md:block'>
                    ...
                    <Link href="/abstract" className='px-4 text-light-blue-100 hover:text-amber-900 text-md'>Abstract</Link>
                    <Link href="/explore" className='px-4 text-light-blue-100 hover:text-amber-900 text-md'>Explore</Link>
                    <Link href="/sponsors" className='px-4 text-light-blue-100 hover:text-amber-900 text-md'>Sponsors</Link>
                    <Link href="/about" className='px-4 text-light-blue-100 hover:text-amber-900 text-md'>About</Link>
